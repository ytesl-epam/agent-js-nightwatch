...
describe('attachData', function() {
  const spyPublishIPCEvent = jest.spyOn(IPCClient, 'publishIPCEvent').mockImplementation(() => {});
  ...
  test('addAttributes: should call spyPublishIPCEvent with ADD_ATTRIBUTES event', function() {
    ...
    expect(spyPublishIPCEvent).toHaveBeenCalledWith(EVENTS.ADD_ATTRIBUTES, {
      attributes: [],
      itemName: 'parentItem',
    });
  });
  ...
  test('addDescription: should call spyPublishIPCEvent with ADD_DESCRIPTION event', function() {
    ...
    expect(spyPublishIPCEvent).toHaveBeenCalledWith(EVENTS.ADD_DESCRIPTION, {
      text: 'description',
      itemName: 'parentItem',
    });
  });
  ...
  test('setTestCaseId: should call spyPublishIPCEvent with SET_TEST_CASE_ID event', function() {
    ...
    expect(spyPublishIPCEvent).toHaveBeenCalledWith(EVENTS.SET_TEST_CASE_ID, {
      id: 'itemTestCaseId',
      itemName: 'parentItem',
    });
  });
  ...
  describe('launch log functions', function() {
    test('launchLog: should call spyPublishIPCEvent with ADD_LAUNCH_LOG event', function() {
      ...
      expect(spyPublishIPCEvent).toHaveBeenCalledWith(EVENTS.ADD_LAUNCH_LOG, {
  ...
  describe('set status functions', function() {
    test('setStatus: should call spyPublishIPCEvent with SET_STATUS event', function() {
      ...
      expect(spyPublishIPCEvent).toHaveBeenCalledWith(EVENTS.SET_STATUS, {
